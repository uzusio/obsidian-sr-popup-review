...
const en: Strings = {
    ...
    settingsDueOnlyDesc: "Only show a popup when a due card is at the head of the review queue. Turn off to also get popups for new cards.",
...
const ja: Strings = {
    ...
    settingsDueOnlyDesc: "レビューキューの先頭が期限カードのときだけポップアップを出します。オフにすると新規カードでも出ます。",
